  ...
  render(){
    ...
    <div className="background">
      <div style={{ textAlign : 'center' }}>
        <div className="col-lg-2.5 col-centered login-card">
          <form>
            <h1 style={{float: 'left', marginBottom: '25px', marginLeft: '27px'}}>Welcome!</h1>

            <div className="input-group mb-4 col-xs-5 w-75 col-centered">
            ...
            <button style = {{margin : '10px', fontSize: '15px', marginRight: '40px'}} onClick = {this.register} className="btn btn-dark btn float-right">Sign Up</button>
            <button style = {{margin : '10px', fontSize: '15px'}} onClick = {this.login} className="btn btn-primary btn float-right">Log In</button>

            <a style={{fontSize: '12px', display: 'block', float: 'right', marginTop: '65px'}} href="#">Forgot your password?</a>
